...
namespace ContextoDev.TallerHexagonal.Warehouse.Infraestructura.Configuracion
{
    public sealed class ProveedorSQLiteConfiguration: IEntityTypeConfiguration<Proveedor>
    {
        public void Configure(EntityTypeBuilder<Proveedor> builder)
        {
           ...
           //});
            ...
            builder.OwnsOne(x => x.Direccion, direccion =>
            {
                direccion.Property(x => x.CallePrincipal)
                    .HasColumnName("direccion_calle_principal")
                    .HasMaxLength(200)
